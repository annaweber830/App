...
function IOURequestStepDistanceManual({
    ...
    const currentTransactionViolations = transaction?.transactionID ? transactionViolations?.[`${ONYXKEYS.COLLECTION.TRANSACTION_VIOLATIONS}${transaction.transactionID}`] : undefined;
